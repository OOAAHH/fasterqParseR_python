# 升级
本身非常完美，但是我需要一个独立运行的版本，便于我在docker中轻量化的调用。或许是python。
...
If you want more guidance on how to run this package, check out this [example](https://github.com/Nusob888/fasterqParseR/blob/7cef949f93c9795ff0e30cfd3671e63df5601133/example_code.R) for more information.
